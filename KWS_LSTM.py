...
parser.add_argument("--ab1", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab2", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab3", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab4", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab5", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab6", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab7", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab8", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab9", type=int, default=16, help='Bits available for weights')
parser.add_argument("--ab10", type=int, default=16, help='Bits available for weights')
